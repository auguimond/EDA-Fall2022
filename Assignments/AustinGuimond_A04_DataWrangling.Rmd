...
levels(Air.PM25.2018.Select$AQS_PARAMETER_DESC)[levels(Air.PM25.2018.Select$AQS_PARAMETER_DESC) == "Acceptable PM2.5 AQI & Speciation Mass"] <- "PM2.5"
levels(Air.PM25.2018.Select$AQS_PARAMETER_DESC)[levels(Air.PM25.2018.Select$AQS_PARAMETER_DESC) == "PM2.5 - Local Conditions"] <- "PM2.5"

levels(Air.PM25.2019.Select$AQS_PARAMETER_DESC)[levels(Air.PM25.2019.Select$AQS_PARAMETER_DESC) == "Acceptable PM2.5 AQI & Speciation Mass"] <- "PM2.5"
levels(Air.PM25.2019.Select$AQS_PARAMETER_DESC)[levels(Air.PM25.2019.Select$AQS_PARAMETER_DESC) == "PM2.5 - Local Conditions"] <- "PM2.5"
...
```{r}
#7
EPA.O3.2018 <- read.csv("./Data/Processed/EPAair_O3_NC2018_Processed.csv", stringsAsFactors = TRUE)
EPA.O3.2019 <- read.csv("./Data/Processed/EPAair_O3_NC2019_Processed.csv", stringsAsFactors = TRUE)
EPA.PM25.2018 <- read.csv("./Data/Processed/EPAair_PM25_NC2018_Processed.csv", stringsAsFactors = TRUE)
EPA.PM25.2019 <- read.csv("./Data/Processed/EPAair_PM25_NC2019_Processed.csv", stringsAsFactors = TRUE)

EPAair.All.New <- rbind(EPA.O3.2018, EPA.O3.2019, EPA.PM25.2018, EPA.PM25.2019)
dim(EPAair.All.New)
