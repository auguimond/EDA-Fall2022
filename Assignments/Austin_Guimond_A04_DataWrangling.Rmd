...
#4
#Select columns from the original dataset
...
#5
#Change all AQS parameter data to PM2.5
...
#9
#spread PM2.5 and Ozone data to new columns
...
#13
#Find summary dimensions 
dim(EPAair.Summary)

```

14. Why did we use the function `drop_na` rather than `na.omit`?
> Answer: Na.omit calculates values in a column while omitting any NA values from the calculations. Drop_na removes all instances of NA from a columm. Calculations are comopleted once all NA have been dropped. Na.omit essentially ignores NA values while drop_na removes any insatnces of NA from the data. In our dataset, we wanted to remove all NA values and not just have them be ignored. 
