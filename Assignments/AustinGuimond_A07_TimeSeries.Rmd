...
Study question: Have ozone concentrations changed over the 2010s at this station? 
> Answer: The graph of monhtly mean ozone values shows a trend of lower ozone values over time. The P value from the seasonal Mann Kendall test is also below .05, which indicates the trend is significant and we can reject our null hupothesis (2-sided pvalue =0.046724). 
