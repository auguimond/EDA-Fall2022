...
#Create a map
mapView(Upper_Neuse_sf, zcol = "HUC_8", col.regions='purple', alpha.regions= 1) + mapView(Huc8_sf, zcol = "HUC_8", col.regions='yellow', alpha.regions=.3)
...
Wind <- st_read('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv')
Wind_HUC8 <- Wind %>%
